...
export function TaskHistory({
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-center gap-3 px-5 py-2.5 border-b border-[var(--cr-border)] bg-[var(--cr-bg-primary)] shrink-0">
        <button
          onClick={onClose}
          className={cn(
      ...
      {/* Runs list */}
      <div className="flex-1 overflow-y-auto px-5 pb-3 space-y-2.5 cr-scrollbar" style={{ scrollbarGutter: "stable both-edges" }}>
